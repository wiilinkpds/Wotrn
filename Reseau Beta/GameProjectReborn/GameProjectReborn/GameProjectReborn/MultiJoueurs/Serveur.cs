    ...
    public class Serveur
    {
        ...
        public void Start()
        {
            foreach (var serveurClient in Clients)
            {
                ...
                serveur.Send(msg, msg.Length, serveurClient.ip);
            }
            Taccept.Abort();
        ...
        public void Sending(List<Player> players)
        {
            ...
            for (int i = 0; i < Clients.Count; i++)
            {
                ...
                sendeur.RemoveAt(i);
                SendMsg(ObjectToByteArray(sendeur), Clients[i]);
            }
        }
        ...
        private void SendMsg(byte[] msg, ServeurClient client)
        {
            serveur.Send(msg, msg.Length, client.ip);
        }
