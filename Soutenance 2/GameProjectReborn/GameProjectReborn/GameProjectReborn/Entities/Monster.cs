...
namespace GameProjectReborn.Entities
{
    public class Monster : Entity
    {
        ...
        {
            spriteBatch.Draw(Texture, Position, Targeter == null ? Color.White : Color.SkyBlue); // condition ? si vrai : si faux
        }
        ...
        public override void DrawUI(GameTime gameTime, UberSpriteBatch spriteBatch)
        {
            ...
            // Draw la barre de Vie si Targeter est non null (ou équivalent à true en C)
        ...
        public void Damage(int life)
        {
            ...
            {
                Delete();
                if (ReferenceEquals(Game.Player.Target, this))
