...
namespace GameProject.Decors
{
    public class Decor
    {
        ...
        public virtual void LoadDecors(ContentManager content, int decor_num) //Load le decor en fonction du int en parametre
        {
            Back = new Sprite();
            DesignDecors.Decors(content, Back, out entite, decor_num, Vector2.Zero);
        }
